...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Для опер. div+,div-: true-разбиение, false-слияние', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'tdIZ', @level2type = N'COLUMN', @level2name = N'DivFlag';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Связь с IzmenReason', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'tdIZ', @level2type = N'COLUMN', @level2name = N'irID';
