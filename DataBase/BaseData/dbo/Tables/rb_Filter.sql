...
6 - по товару Hitag=K', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'rb_Filter', @level2type = N'COLUMN', @level2name = N'tip';
