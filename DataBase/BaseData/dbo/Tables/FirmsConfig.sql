CREATE TABLE [dbo].[FirmsConfig] (
    [Our_id]            SMALLINT       NOT NULL,
    ...
    [Old_OurID]         INT            NULL,
    CONSTRAINT [FirmsConfig_pk] PRIMARY KEY CLUSTERED ([Our_id] ASC)
);


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Текущее значение кассы для организации', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FirmsConfig', @level2type = N'COLUMN', @level2name = N'KassaVal';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Актуальные фирмы', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FirmsConfig', @level2type = N'COLUMN', @level2name = N'Actual';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Имя компьютера с кассовым аппаратом соответствующей фирмы', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'FirmsConfig', @level2type = N'COLUMN', @level2name = N'CompRegName';
