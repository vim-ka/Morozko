CREATE procedure dbo.EloadSertificatsStatisticsCollapse
@nd1 datetime,
@nd2 datetime
as
begin
...
where c.datnom>=@dat1
      ...
      and (c.Remark like '%вет%' or
           ...
           exists(select 1 from defcontract dc inner join AgentList al on dc.ag_id=al.AG_ID where dc.pin=d.pin and al.DepID=3) or
           exists(select 1 
      					 from dbo.nv v 
