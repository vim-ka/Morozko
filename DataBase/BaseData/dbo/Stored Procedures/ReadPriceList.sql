CREATE procedure dbo.ReadPriceList @PLID smallint, @FirmGroup smallint=7
...
begin
  ...
  FROM 
    ...
    left join NomenBrand B on B.nbid=nm.nbid
  order by par.grpname, g.grpname, B.BrandName, nm.Name;
