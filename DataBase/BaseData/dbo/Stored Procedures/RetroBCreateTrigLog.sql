CREATE procedure RetroBCreateTrigLog (@TableName VARCHAR(128)) 
as
...
begin
  ...
  begin 
    ...
    EXECUTE (' EXEC sp_addextendedproperty ''MS_Description'', N''тип изменения 0 - insert, 1 - delete, 2 - update'', N''schema'', N''RetroB'', N''table'', N'''+@TableName+'Log'', N''column'', N''type''; ');
    EXECUTE (' EXEC sp_addextendedproperty ''MS_Description'', N''имя пользователя'', N''schema'', N''RetroB'', N''table'', N'''+@TableName+'Log'', N''column'', N''user_name'';');
    EXECUTE (' EXEC sp_addextendedproperty ''MS_Description'', N''время изменения'', N''schema'', N''RetroB'', N''table'', N'''+@TableName+'Log'', N''column'', N''datetime'';');  
    EXECUTE (' EXEC sp_addextendedproperty ''MS_Description'', N''имя компа'', N''schema'', N''RetroB'', N''table'', N'''+@TableName+'Log'', N''column'', N''host_name'';');
  	EXECUTE (' EXEC sp_addextendedproperty ''MS_Description'', N''имя приложения'', N''schema'', N''RetroB'', N''table'', N'''+@TableName+'Log'', N''column'', N''app_name'';');
