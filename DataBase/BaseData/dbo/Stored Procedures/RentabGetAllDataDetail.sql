CREATE PROCEDURE dbo.RentabGetAllDataDetail @day0 datetime, @day1 datetime, @ncod int, @ngrp int, @with_actn bit, 
...
inner join dbo.Vendors vdr on vdr.ncod = t.ncod_p
group by t.obl_id, t.ngrp, t.ncod, t.hitag, n.name, t.ncod_p, vdr.fam
