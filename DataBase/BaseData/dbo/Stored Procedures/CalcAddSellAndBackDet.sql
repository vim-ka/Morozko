create procedure CalcAddSellAndBackDet @day0 datetime, @day1 datetime
AS
begin
  ...
  select #a.hitag, nm.[name], sum(#a.kol) as kol, sum(#b.kol_b) as kol_b 
  from 
