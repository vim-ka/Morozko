CREATE PROCEDURE dbo.SkladPrepareListFiltered
...
--if patindex('terminal%',lower(host_name()))>0 
--	return 0   

set transaction isolation level read uncommitted
/*это новая процедура старая называется dbo.SkladPrepareListFiltered_*/
--insert into TerminalLog(skladlist,nd,type) values(@skladlist,@nd,@type)
