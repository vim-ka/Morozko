/* Просмотр старой накладной:
1. @DCK = 0
2. @SkladList = null
3. @Datnom = 18090500001
4. @Action = 1
5. @IdList = null
6. @OurID = 0
7. @Ag_ID = null
...
CREATE procedure dbo.GenerPricesNSP2b @DCK INT, @SkladList varchar(3000)=NULL,
  @Datnom bigint=0, 
  @Action tinyint=0,
...
-- SELECT '#LocalTDVI' AS tabName, * FROM #LocalTDVI;
  ...
  -- SELECT '#LocalDefContract' AS tabname, * FROM #LocalDefContract  
...
-- SELECT '#DetWhat' AS TabName, * FROM #DetWhat;
