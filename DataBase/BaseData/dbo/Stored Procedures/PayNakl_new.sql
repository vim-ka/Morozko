CREATE PROCEDURE dbo.[PayNakl_new] @B_id int, @master int, @Plata money,@Remark varchar(60), @op int,
              @Bank_id int,@BankDay datetime, @Pay money OUTPUT, @DCK int=0, @DCKMaster int=0  /*, @NNak int, @ND Datetime,
              @DatNom int*/
AS
BEGIN
