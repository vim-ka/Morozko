CREATE procedure AddInpdet2
  ...
  @country varchar(15), @sklad tinyint, @kol_b int, @summacost money, @BasePrice money
as
begin
...
insert into InpDet (ND, Ncom, Id, Hitag, Price, Cost, kol, Sert_id, minp, mpu, dater,
  srokh, nalog5, op, country, sklad, kol_b, summacost, baseprice)
