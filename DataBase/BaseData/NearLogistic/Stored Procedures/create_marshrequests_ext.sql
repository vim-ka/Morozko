CREATE procedure NearLogistic.create_marshrequests_ext
@docdate datetime, @docnom varchar(100), @extcode varchar(50), @mas decimal(15,2), @vol decimal(15,2), @box int, @pal decimal(15,4), @temp int, @cost money,
@contact varchar(500), @remark varchar(500),
@ext_pin_code varchar(50), @pinname varchar(100), 
@ext_adress_code varchar(50), @adress varchar(500), @adress_name varchar(50), @tm varchar(5), @posx float, @posy float,
@ext_sklad_code varchar(50), @sklad_adress varchar(500), @delivdate datetime, @nal bit
as
begin
	set nocount on
  ...
  if exists(select 1 from nearlogistic.marshrequests_points where extcode=@ext_adress_code)
  ...
  if exists(select 1 from nearlogistic.marshrequests_points where extcode=@ext_sklad_code)
