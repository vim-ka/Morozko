CREATE procedure Guard.ModComplete @day0 datetime, @day1 DATETIME,
...
begin
  ...
  select -- 'Final' as remark, 
    ...
    #p.b_id, def.gpName as Buyer,#mp.PlanV,  gr.Ngrp , gr.GrpName,
    sum(iif(isnull(#m.rest,0)=0,0,1)) as Sver
  from 
    #p 
  ...
  group by 
    ...
    #p.b_id, def.gpName, #mp.PlanV, gr.Ngrp, gr.GrpName -- gr.MainParent, g2.GrpName
