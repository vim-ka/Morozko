CREATE PROCEDURE [LoadData].UnloadAlienRealizNew1 @Our_ID int, @DateStart datetime, @DateEnd datetime, @AlienSale bit, @Sertif bit, @Back int
AS
BEGIN
  ...
  where ((n.datnom between @datnomStart and @datnomEnd and n.sp>0 and @Back=0) or (n.datnom between @datnomStart and @datnomEnd and n.sp<0 and @Back=1))
