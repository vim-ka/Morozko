CREATE function [RetroB].BasCheckPricePrihod2 (@PrihodReqID int)
returns @res table (id int, [tekid] int, msg varchar(100), spec int, PrihodCost decimal(15,5),[cost1kg] decimal(15,5), prID int, BaseCost decimal(15,5), flgWeight bit)
AS
begin
